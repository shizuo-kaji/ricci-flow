...
# %%
np.savetxt(os.path.join(args.outdir,"curvatures_target_dmat_final.txt"),np.vstack([targetK[constrained_vert], g_dmat._K[constrained_vert], g_final._K[constrained_vert]]).T,fmt='%1.8f')
